...
<title>NMAMIT</title>
<body>
<img src="logo.png"  align="left"width="300" height="100">
<center><img src="nmam-institute-of-technology-nmamit-karnataka.jpg" width="300" height="100">
<img src="logo.png" align="right"  width="300" height="100"></center>
  ...
  <div class="tbl-content">
    <table cellpadding="0" cellspacing="0" border="0">
      ...
      <%try
      {
    	  Connection con=ConnectionProvider.getCon();
    	  Statement st=con.createStatement();
    	  ResultSet rs=st.executeQuery("select *from result5");
    	  while(rs.next())
    	  {
      %>
        <tr>
