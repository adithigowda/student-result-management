...
try
{
	...
	ResultSet rs=st.executeQuery("select *from student5 inner join result5 where student5.rollNo=result5.rollNo and student5.rollNo='"+rollNo+"'");
	if(rs.next())
	{
%>
<img src="logo.png"  align="left"width="300" height="150">
<center><img src="nmam-institute-of-technology-nmamit-karnataka.jpg" width="300" height="150">
<img src="logo.png" align="right"  width="300" height="150"></center>
